...
#Description: This file contains list of movies that will be shown on movie trailer website

import media
import ud036_StarterCode.fresh_tomatoes
...
life_is_beautiful = media.Movie("Life Is Beautiful",
	"A Jewish Italian book shop owner employs his fertile imagination to shield his son from the horrors of Nazi camp",
...
troy = media.Movie("Troy",
	"Troy is a 2004 epic period war film. It is loosely based on Home's Illiad.",
...
ud036_StarterCode.fresh_tomatoes.open_movies_page(MovieList)
